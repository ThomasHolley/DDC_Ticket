 ...
 */
final class Version20210712143450 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE ticket (id INT AUTO_INCREMENT NOT NULL, demandeur_id INT NOT NULL, agent_id INT NOT NULL, etat_ticket_id INT NOT NULL, titre VARCHAR(255) NOT NULL, message VARCHAR(255) NOT NULL, date DATETIME NOT NULL, INDEX IDX_97A0ADA395A6EE59 (demandeur_id), INDEX IDX_97A0ADA33414710B (agent_id), INDEX IDX_97A0ADA38092013E (etat_ticket_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE ticket ADD CONSTRAINT FK_97A0ADA38092013E FOREIGN KEY (etat_ticket_id) REFERENCES etat (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ticket DROP FOREIGN KEY FK_97A0ADA38092013E');
